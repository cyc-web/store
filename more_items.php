   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Upload Items Page</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">Upload Items Page</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="mb-3">
               ...
               <p style="color: red; font-size: 20px; margin-top: 50px; text-align: center;">Please make sure that the items typed in excel and save as csv(comma delimited) in the format below</p>
